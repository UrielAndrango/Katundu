    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registrat.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                StringBuilder url_builder = new StringBuilder("https://us-central1-test-8ea8f.cloudfunctions.net/signup?un=test&pw=1234&n=testname&lat=12&lon=34");


                url_builder.append(usernameEditText.getText());
                url_builder.append(nameEditText.getText());
                url_builder.append(passwordEditText.getText());
                url_builder.append(repeatpasswordEditText.getText());
                url_builder.append(latitudeEditText.getText());
                url_builder.append(longitudeEditText.getText());
